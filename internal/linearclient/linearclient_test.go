...
// Config-file resolution-order tests (global fallback, cwd-precedence, quote-stripping) moved to
// internal/tokensrc/tokensrc_test.go, generalized over Resolve directly — this file keeps only the
// New()-level behavior tests.
